...
<div class="container">
  <div class="row">
    <div class="col-6 text-center offset-md-3">
      <img src="<?php echo IMAGES.'keteke_logo_white.png' ?>" alt="Keteke Framework" class="img-fluid" style="width: 200px;">
      <h2 class="text-white mt-5 mb-3"><span class="text-warning">Keteke</span> Framework</h2>
      <p class="text-center text-white">Un framework casero, creado con pasión y mucho cariño. Ligero, rápido y personalizable. Úselo como quiera, en sus proyectos personales o profesionales.</p>
      <ul class="text-white">
